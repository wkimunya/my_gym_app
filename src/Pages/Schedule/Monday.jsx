  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <Link
          to="/schedule/monday"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] bg-[#007FFF] ease-in duration-200 hover:shadow-2xl text-white "
        >
          Monday
        </Link>
        ...
        <Link
          to="/schedule/tuesday"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] hover:bg-[#007FFF] ease-in duration-200 hover:shadow-2xl hover:text-white "
        >
          Tuesday
        </Link>
          ...
          <ul className="flex justify-between w-full min800:flex-col min800:text-center">
            ...
            <li className="py-[25px] px-[55px] bg-[#f2f2f2] w-full  min800:justify-center items-center flex justify-end">
              <Link
                ...
                to="/contact"
                className="text-white text-[15px] font-medium bg-[#555] py-[10px] px-[20px] rounded-[30px] hover:bg-[#007FFF] ease-in duration-200  "
              >
                Join Now
              </Link>
            </li>
          ...
          <ul className="flex justify-between w-full min800:flex-col min800:text-center">
            ...
            <li className="py-[25px] px-[55px] bg-[#f2f2f2] w-full min800:justify-center items-center flex justify-end">
              <Link
                onClick={() => window.top(0, 0)}
                to="/contact"
                className="text-white text-[15px] font-medium bg-[#555] py-[10px] px-[20px] rounded-[30px] mt-3 hover:bg-[#007FFF] ease-in duration-200 "
              >
                Join Now
              </Link>
            </li>
